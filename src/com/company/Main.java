...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" l'image de B est : "+b.imagePoint());
        System.out.println(" l'image de C est : "+c.imagePoint());
